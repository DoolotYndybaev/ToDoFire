...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Если наш пользователь был зарегистрирован
    ...
    // viewWillAppear - срабатывает когда мы только загружаем LoginViewController
    // И сдесь мы приравниваем наши данные к пустому значению!
    //         emailTextField.text = ""
    ...
    @objc func kbDidShow(notification: Notification) {
        // Первое - Мы должны достать словарик с различной информацией из нашего notification
        guard let userInfo = notification.userInfo else { return }
        // Теперь мы должны взять размер клавиатуры
        // скастим до NSValue
        // NSValue содержит cgRectValue
